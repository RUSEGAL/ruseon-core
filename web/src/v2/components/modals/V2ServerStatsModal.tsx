        ...
        <div className="v2-modal-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc' }}>
              {t('v2.modals.stats.title', 'Advanced System & Go Diagnostics')}
            </h3>
          </div>
        ...
        <div className="v2-modal-body" style={{ gap: '1.25rem' }}>
          ...
          >
            ...
            >
              <div style={{ fontSize: '0.72rem', color: '#94a3b8', display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <span>{t('v2.modals.stats.goroutines', 'ACTIVE GOROUTINES')}</span>
              </div>
            ...
            >
              <div style={{ fontSize: '0.72rem', color: '#94a3b8', display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <span>{t('v2.modals.stats.cpuCores', 'LOGICAL CPU CORES')}</span>
              </div>
            ...
            >
              <div style={{ fontSize: '0.72rem', color: '#94a3b8' }}>{t('v2.modals.stats.heapAlloc', 'TOTAL HEAP ALLOC')}</div>
            ...
            >
              <div style={{ fontSize: '0.72rem', color: '#94a3b8' }}>{t('v2.modals.stats.sysMemory', 'SYSTEM MEMORY (SYS)')}</div>
            ...
            >
              <div style={{ fontSize: '0.72rem', color: '#94a3b8' }}>{t('v2.modals.stats.heapObjects', 'HEAP OBJECTS COUNT')}</div>
              <div style={{ fontSize: '1.3rem', fontWeight: 700, color: '#f8fafc', marginTop: '4px' }}>
            ...
            >
              <div style={{ fontSize: '0.72rem', color: '#94a3b8' }}>{t('v2.modals.stats.gcRuns', 'GARBAGE COLLECTIONS')}</div>
              <div style={{ fontSize: '1.3rem', fontWeight: 700, color: '#f8fafc', marginTop: '4px' }}>
          ...
          >
            <div style={{ fontSize: '0.82rem', fontWeight: 700, color: '#f8fafc', display: 'flex', alignItems: 'center', gap: '6px' }}>
              ...
              <span>{t('v2.modals.stats.backupTitle', 'Full System Configuration Backup')}</span>
            </div>
            <div style={{ fontSize: '0.75rem', color: '#94a3b8' }}>
              {t('v2.modals.stats.backupDesc', 'Export or import the entire database of camera streams, folders, tags, and users in JSON format.')}
            </div>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '4px' }}>
              ...
              >
                <Download size={14} />
                <span>{t('v2.modals.stats.downloadBackup', 'Download JSON Backup')}</span>
              </a>

              <label className="v2-btn-secondary" style={{ cursor: 'pointer' }}>
                <Upload size={14} />
                <span>{t('v2.modals.stats.uploadBackup', 'Upload JSON Backup')}</span>
                <input
                  type="file"
                  accept=".json"
                  style={{ display: 'none' }}
