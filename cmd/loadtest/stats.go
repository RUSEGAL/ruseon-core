...
func (r *BenchmarkResult) FormatMarkdown() string {
	...
	sb += "2. **Дисковая подсистема (30 MB/s на 100 камер):**\n"
	...
	sb += "3. **Защита ядра от медленных клиентов (Slow Consumers):**\n"
	...
	sb += "2. **Storage Subsystem (30 MB/s per 100 cameras):**\n"
	...
	sb += "3. **Core Protection Against Slow Consumers:**\n"
