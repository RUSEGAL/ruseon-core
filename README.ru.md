...
> **Итог:** RUSEON Core играючи утилизирует пропускную способность сетевых интерфейсов 10G (10 Gigabit Ethernet), сохраняя задержку ответа менее 6 миллисекунд для тысяч TCP-соединений. Проблема Thundering Herd полностью решена на уровне архитектуры!
